              ...
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  <p>
                    ...
                    thinking. ThrifTrade strives to be Earth’s most
                    ...
                    ThrifTrade, AWS, Kindle Direct Publishing, Kindle, Career
                    Choice, Fire tablets, Fire TV, ThrifTrade Echo, Alexa, Just
                    Walk Out technology, ThrifTrade Studios, and The Climate
                    Pledge are some of the things pioneered by ThrifTrade.
                  </p>
            ...
            <Col sm={12} md={4}>
              <div className="card">
                ...
                <div className="card-content">
                  <h2>Our Mission</h2>
                  <p>
                    ThrifTrade's mission statement and vision statement
                    influence the multinational technology and e-commerce
                    business toward long-term growth and success. This success
                    is attributed to stringent measures to ensure that the
                    vision and mission statements are fulfilled. In theory, the
                    corporate vision statement provides organizational direction
                    toward a desired future condition of the business, while the
                    corporate mission statement presents the business purpose
                    and goals that guide strategic management in the company.
                  </p>
                  <a href="#" className="card-link">
                    Learn More
                  </a>
              ...
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  <p>
                    ...
                    protect them from risk, online or offline. Whether
                    campaigning for tougher data privacy laws or raising
                    awareness of global issues, we’re setting the bar high.
                  </p>
                  <a href="#" className="card-link">
                    Learn More
                  </a>
